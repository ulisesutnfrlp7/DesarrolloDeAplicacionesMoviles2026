...
export default function PlanillasScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#F5F5F5" }}>
      <ScreenHeader
        titulo="Planillas de trabajos practicos"
        onBack={() => router.back()}
        mostrarHome
      />
      <View style={styles.container}>
        <View style={styles.iconBg}>
          <Ionicons name="clipboard-outline" size={34} color="#0F4A32" />
        </View>
        <Text style={styles.title}>Planillas de trabajos practicos</Text>
        <Text style={styles.text}>
          Proximamente se podran cargar y gestionar planillas de trabajos practicos.
        </Text>
